...
function onCreate()
    ...
    makeLuaSprite('mouse', 'backgrounds/sonic/exe/fatal/fatal_mouse_cursor', getMouseX('other'), getMouseY('other'));   
    setProperty('mouse.antialiasing', false);
    setProperty('mouse.visible', false);
    scaleObject('mouse', 1.5, 1.5)
    addLuaSprite('mouse', true);
    setObjectCamera('mouse', 'other')	
    setObjectOrder('mouse', 100)

    for i = 1,10 do
        makeAnimatedLuaSprite('error_popups'..i, 'backgrounds/sonic/exe/fatal/error_popups', getRandomInt(0, 700), getRandomInt(0, 300))
        ...
        makeLuaSprite('hitBox'..i, 'backgrounds/sonic/exe/fatal/hitBox', getProperty('error_popups'..i..'.x') + xpos, getProperty('error_popups'..i..'.y') + ypos)
    ...
    if name == 'Fatality Popup' then 
        ...
        if value2 == 1 then   
            for j = 1,value1 do
                ...
                addLuaSprite('error_popups'..i, false)
                setObjectCamera('error_popups'..i, 'other')
                objectPlayAnimation('error_popups'..i, 'idle') 
                setObjectOrder('error_popups'..i, 30)
                if ransize == 1 then
                    xpos = 193
                    ypos = 192
                    SOX = 0.55
        ...
        elseif value2 == 2 then
            for j = 1,value1 do
                ...
                ransize1 = 2.5
                makeAnimatedLuaSprite('error_popups'..ugh, 'backgrounds/sonic/exe/fatal/error_popups', getRandomInt(0, 600), getRandomInt(0, 300))
                ...
                setObjectOrder('error_popups'..ugh, 30)

                makeLuaSprite('hitBox'..ugh, 'backgrounds/sonic/exe/fatal/hitBox', getProperty('error_popups'..ugh..'.x') + 302, getProperty('error_popups'..ugh..'.y') + 300)
        ...
        elseif value2 == 3 then
            for j = 1,value1 do
                ...
                ransize1 = 4.7
                makeAnimatedLuaSprite('error_popups'..ugh, 'backgrounds/sonic/exe/fatal/error_popups', -40, -65)
                addAnimationByPrefix('error_popups'..ugh, 'idle', 'idle', 24, false);
                addAnimationByPrefix('error_popups'..ugh, 'end', 'end', 36, false);
                scaleObject('error_popups'..ugh, ransize1, ransize1)
                setProperty('error_popups'..ugh..'.antialiasing', false);
                ...
                setObjectCamera('error_popups'..ugh, 'other')
                setObjectOrder('error_popups'..ugh, 30)
                makeLuaSprite('hitBox'..ugh, 'backgrounds/sonic/exe/fatal/hitBox', getProperty('error_popups'..ugh..'.x') + 568, getProperty('error_popups'..ugh..'.y') + 564)
                setObjectCamera('hitBox'..ugh, 'other')
...
function onUpdate(elapsed)
    ...
    for i = 1, 100 do
        if getProperty('error_popups'..i..'.visible') == true then
            return;
        end
    end
