...
function new() {
	...
	pauseMusic.volume = 1;
	pauseMusic.pitch = FlxG.sound.music.pitch;
...
function fadeOut() {
	if (pauseMusic != null) {
		FlxTween.cancelTweensOf(pauseMusic);
		FlxTween.tween(pauseMusic, {volume: 0, pitch: pauseMusic.pitch * 4}, 0.5, {ease: FlxEase.quadOut});
	}
	...
	if (state == null) {
		...
		//FlxTween.tween(fadeOutSpr, {alpha: 0}, 0.25, {ease: FlxEase.quadOut, onComplete: function() {
